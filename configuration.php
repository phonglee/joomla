...
class JConfig {
	...
	/* Database Settings */
	public $dbtype = 'postgresql';					// Normally mysql
	public $host = 'ec2-54-243-249-65.compute-1.amazonaws.com';					// This is normally set to localhost
	public $user = 'vsvmketdsaxfvk';							// DB username
	public $password = '_HakDAVYsSyJOeNzaf_drUJ5d7';						// DB password
	public $db = 'd7nulpb6kiihih';							// DB database name
	public $dbprefix = 'ivsap_';					// Do not change unless you need to!
