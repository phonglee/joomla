(function ($) {
    $.fn.daterangepicker=function(s){
        ...
        d.datepickerOptions=(s)?$.extend(f,s.datepickerOptions):f;
        ...
        var i=$('<div class="ui-daterangepicker ui-widget ui-helper-clearfix ui-widget-content ui-corner-all"></div>');
        var u=(function(){
            var y=$('<ul class="ui-widget-content"></ul>').appendTo(i);
            $.each(d.presetRanges,function(){
                $('<li class="ui-daterangepicker-'+this.text.replace(/ /g,"")+' ui-corner-all"><a href="#">'+this.text+"</a></li>").data("dateStart",this.dateStart).data("dateEnd",this.dateEnd).appendTo(y)
            });
            var w=0;
            $.each(d.presets,function(x,z){
                $('<li class="ui-daterangepicker-'+x+" preset_"+w+' ui-helper-clearfix ui-corner-all"><span class="ui-icon ui-icon-triangle-1-e"></span><a href="#">'+z+"</a></li>").appendTo(y);
                w++
            });
        ...
        function a(y){
            ...
            A++;
            var w=d.dateFormat;
            return $.datepicker.formatDate(w,y)
        }
        ...
        function v(){
            var w=o||c;
            var A=w.offset(),y="left",z=A.left,x=$(window).width()-z-w.outerWidth();
            if(z>x){
                y="right",z=x
            }
        ...
        var m=$('<div class="ranges ui-widget-header ui-corner-all ui-helper-clearfix"><div class="range-start"><span class="title-start">Start Date</span></div><div class="range-end"><span class="title-end">End Date</span></div></div>').appendTo(i);
        ...
        var e=$('<button class="btnDone ui-state-default ui-corner-all">'+d.doneButtonText+"</button>").click(function(){
        ...
        if(d.arrows&&c.size()==1){
            var g=$('<a href="#" class="ui-daterangepicker-prev ui-corner-all" title="'+d.prevLinkText+'"><span class="ui-icon ui-icon-circle-triangle-w">'+d.prevLinkText+"</span></a>");
            var q=$('<a href="#" class="ui-daterangepicker-next ui-corner-all" title="'+d.nextLinkText+'"><span class="ui-icon ui-icon-circle-triangle-e">'+d.nextLinkText+"</span></a>");
            $(this).addClass("ui-rangepicker-input ui-widget-content").wrap('<div class="ui-daterangepicker-arrows ui-widget ui-widget-header ui-helper-clearfix ui-corner-all"></div>').before(g).before(q).parent().find("a").click(function(){
